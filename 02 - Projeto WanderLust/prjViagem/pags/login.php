        ...
        <div class = "corpo_todo">
            ...
            <div class = "corpo">
                <div class = "div_corpo_titulo">
					<h2><span class = "corpo_titulo"> FAÇA SEU LOGIN </span></h2>
				</div>
                <form action = "../pags/verifica.php" method = "POST" id = "form1" style = "margin-left: calc(50% - 299px);">
                    <div class = "formulario">
                        ...
                        <div class = "estrutura">
                            ...
                            <div class = "button">
                                <input type = "submit" class = "in_button" value = "LOGAR"/>
                            </div>
                        </div>
                    </div>
                </form>
